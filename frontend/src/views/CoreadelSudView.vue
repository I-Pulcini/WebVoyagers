...
/* --- VIAGGIO COREA DEL SUD --- */

const router = useRouter()


const ID_VIAGGIO_COREADELSUD = 11
...
<template>
  <div class="coreadelsud-wrapper">
    <header class="fascia-foto">
      <h1 class="fascia-titolo"> COREA DEL SUD </h1>
    </header>
    ...
    <div class="prenota-bar">
      <div class="prenota-info">
        ...
        <span class="prenota-durata"> 9 giorni ·Novembre </span>
      </div>
    ...
    <main>
      ...
      <section class="itinerario-container">
        ...
        <button class="accordion">Day 1-2:Arrivo a Seoul </button>
        <div class="panel" style="background-image: url('/Seoul.jpg');">
            <div class="testo-giorno">
                  <b>Day 1 :</b>partenza dall’Italia con volo con scalo per Seoul <br><br>
                <b> Day 2 Pomeriggio:</b>arrivo a Seoul, l’immensa capitale, hub storico e culturale della Corea del Sud, e trasferimento in hotel <br><br>
                <b>Day 2 Sera:</b>   cena e prima serata in Corea nei bar di Myeongdong, uno dei cuori della nightlife della capitale, o nel quartiere trendy di Gangnam          
        	</div>
        </div>

        <button class="accordion">Day 3-4-5: Alla scoperta di Seoul </button>
        <div class="panel" style="background-image: url('/Seoul2.jpg');">
            <div class="testo-giorno">
                <b>Day 3:</b> Alla scoperta della Seoul antica e moderna <br><br>
                <b>Day 4:</b> Mercati e N tower di Seoul <br><br>
                <b>Day 5:Tour guidato per andare a toccare con mano la guerra tra le due Coree. Alla scopera della Zona Demilitarizzati. Il pomeriggio treno per Gyeongju, l'antica capitale della Corea del Sud </b>             
      	</div>
        </div>

        <button class="accordion">Day 6: Gyeongju</button>
        <div class="panel" style="background-image: url('/Gyeongju.jpg');">
            <div class="testo-giorno">
                   <b>Mattina:</b>Passeggiata a Gyeongju e pranzo e visita della cittadina <br><br>
                <b>Pomeriggio:</b> visita dei complessi di tombe reali a tumulo di Gyeongju, sito patrimonio UNESCO, immerse in pacifici parchi ai margini della città vecchia. Nelle vicinanze, visita del palazzo di Donggung, affacciato sul laghetto artificiale Wolji, risalente al periodo della dinastia Silla <br><br>
                <b>Sera:</b>  cena e serata a Gyeongju  
            </div>
        </div>

        <button class="accordion">Day 7-8:Busan </button>
        <div class="panel" style="background-image: url('/Busan.jpg');">
            <div class="testo-giorno">
                   <b> Day 7 Mattina:</b> Treno verso Busan partendo da Gyeongju.<br><br>
                <b> Day 7 Pomeriggio:</b>visita del villaggio di Gamcheon, nato come quartiere popolare degli anni ‘30 per ospitare i rifugiati della guerra di Corea, e reinventatosi negli ultimi anni come centro culturale e artistico, riconoscibile per le sue pittoresche case colorate abbarbicate su una collina <br><br>
                <b> Day 8 Mattina/Pomeriggio: Visita nel quartiere di Nampo e pranzo a base di street food nei pressi di Jagalchi, il mercato del pesce più grande della Corea e uno dei più vibranti d’Asia. Passeggiata nella vicina BIFF, «cittadella» del festival del cinema, una versione coreana della Hollywood Walk of Fame. Nel pomeriggio, relax nelle spiagge e nei parchi costieri di Busan  </b>   
              <b>Day 8 Sera:</b> Treno direzione Seoul e cena nella capitale.
            </div>
        </div>

        <button class="accordion">Day 9: Rientro in Italia </button>
        <div class="panel" style="background-image: url('/Seoul.jpg');">
            <div class="testo-giorno">
                <b>Pomeriggio:</b>ientro in Italia con volo con scalo.. E alla prossima avventura!! <br><br>
      ...
      <section class="galleria-grid">
          <div class="foto-grid" style="background-image: url('/Seoul.jpg');"></div>
          <div class="foto-grid" style="background-image: url('/Busan.jpg');"></div>
          <div class="foto-grid" style="background-image: url('/Seoul2.jpg');"></div>
      </section>
    ...
    <div v-if="modaleAperto" class="modale-overlay" @click.self="chiudiModale">
      <div class="modale-content">
        ...
        <div v-else>
          ...
          <h2 class="modale-titolo">🎒 Prenota: SEOUL </h2>
