...
<template>
  <div class="thailandia-wrapper">
    <header class="fascia-foto">
      <h1 class="fascia-titolo"> THAILANDIA </h1>
    </header>
    ...
    <main>
      ...
      <section class="itinerario-container">
        ...
        <div class="panel" style="background-image: url('/Ayatthaya.jpg');">
            <div class="testo-giorno">
                   <b>Mattina:</b> Colazione e partenza in treno per Ayutthaya. Visita in bici dei principali templi della città, tra cui il Wat Mahathat, tempio della grande reliquia, noto per la testa del Buddha e il Wat Phra Sri Sanphet, il più sacro tra i templi del complesso dell’antico palazzo reale di Ayutthaya <br><br>
