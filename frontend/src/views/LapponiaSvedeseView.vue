...
const ID_VIAGGIO_LAPPONIASVEDESE = 2
...
const inviaPrenotazione = async () => {
  ...
  try {
    ...
    const response = await fetch('/api/prenota-viaggio', {
      ...
      credentials: 'include',
      body: JSON.stringify({
        idViaggio: ID_VIAGGIO_LAPPONIASVEDESE,
  ...
  <div class="lapponiasvedese-wrapper">
    ...
    <main>
      ...
      <section class="galleria-grid">
          <div class="foto-grid" style="background-image: url('/Stoccola.jpg');"></div>
          <div class="foto-grid" style="background-image: url('/Kiruna.jpg');"></div>
          <div class="foto-grid" style="background-image: url('/Lapponia.jpg');"></div>
      </section>
    ...
    <div v-if="modaleAperto" class="modale-overlay" @click.self="chiudiModale">
      <div class="modale-content">
        ...
        <div v-else>
          ...
          <h2 class="modale-titolo">🎒 Prenota:Lapponia Svedese </h2>
