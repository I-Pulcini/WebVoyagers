  ...
  <div class="yemen-wrapper">
    ...
    <div class="prenota-bar">
      <div class="prenota-info">
        <span class="prenota-prezzo"> 6100€</span>
...
Chiunque abbia avuto, ormai decenni fa, il privilegio di farlo, definisce lo Yemen come uno dei viaggi più belli al mondo. Negli ultimi 20 anni, il paese è stato funestato da gravi conflitti interni, carestie e problematiche socio-economiche, rendendo i viaggi di fatto impossibili. La situazione è lontana dalla stabilità, ma c’è un raggio di luce: nella regione orientale dell’Hadramawt tra le più belle del paese, la situazione è in lento miglioramento. Ed è qui che si svolgerà la nostra spedizione di 6 giorni, alla scoperta del porto di Mukhalla e delle remote vallate del Wadi Dawat, tra canyon e villaggi in fango arroccati su speroni rocciosi, per finire con i grattacieli ante litteram di Shibam, la mitica «Manhattan del deserto»
      ...
      <section class="itinerario-container">
        ...
        <div class="panel" style="background-image: url('/Yemen.jpg');">
            <div class="testo-giorno">
                 <b>Day1:</b> Volo dall'Italia direzione Cairo e notte lì<br><br>
                <b>Day 2:</b> Volo dal Cairo verso Seiyun <br><br>
            </div>
        </div>

        <button class="accordion">Day 3: Seiyun </button>
        <div class="panel" style="background-image: url('/Seiyun.jpg');">
            <div class="testo-giorno">
                 <b>Mattina/Pomeriggio:</b> Spostamento verso Seiyun Old Town per acquisto abiti locali e visita della caotica città <br><br>
               
                <b>Sera:</b> cena in hotel e relax         
        </div>
        </div>

         <button class="accordion">Day 4-5: Mukalla e Wadi Sah </button>
        <div class="panel" style="background-image: url('/Mukalla.jpg');">
           ...
           <button class="accordion">Day 6-7-8: Wadi Doa'n e Shibam </button>
        <div class="panel" style="background-image: url('/Shibam.jpg');">
            <div class="testo-giorno">
      ...
      <button class="accordion">Day 9-10-11: Aynat e Tarim </button>
        ...
        <button class="accordion">Day 12-13: Verso Seiyun e rientro a casa </button>
        <div class="panel" style="background-image: url('/Yemen2.jpg');">
            <div class="testo-giorno">
      ...
      <section class="galleria-grid">
          <div class="foto-grid" style="background-image: url('/Yemen.jpg');"></div>
          <div class="foto-grid" style="background-image: url('/Yemen2.jpg');"></div>
          <div class="foto-grid" style="background-image: url('/Mukalla.jpg');"></div>
      </section>
    ...
    <div v-if="modaleAperto" class="modale-overlay" @click.self="chiudiModale">
      <div class="modale-content">
        ...
        <div v-else>
          ...
          <h2 class="modale-titolo">🎒 Prenota: YEMEN  </h2>
