...
const ID_VIAGGIO_REPUBBLICADOMENICANA = 28
  ...
  <div class="repubblicadomenicana-wrapper">
    ...
    <div class="prenota-bar">
      <div class="prenota-info">
        ...
        <span class="prenota-durata">11 giorni ·Aprile</span>
      </div>
...
Dimenticate la solita vacanza: questo viaggio di 11 giorni è un'immersione totale nei contrasti e nelle meraviglie della Repubblica Dominicana. Lontano dai cliché, vi porteremo a scoprire il vero cuore dei Caraibi. Inizieremo passeggiando tra i vicoli acciottolati e la storia secolare di Santo Domingo, la prima città del Nuovo Mondo. Ci sposteremo poi verso il nord lussureggiante, nella penisola di Samaná, dove foreste incontaminate si tuffano in un oceano dalle sfumature smeraldo. Infine, ci lasceremo cullare dalle acque cristalline del Mar dei Caraibi a Bayahibe, tra atolli disabitati, stelle marine e barriere coralline. Un itinerario perfetto per chi cerca il giusto equilibrio tra esplorazione culturale, avventura nella natura e relax su spiagge da cartolina.
        </p>
      </section>
